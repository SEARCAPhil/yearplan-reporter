...
#var_dump($req_val->activities);echo '<br/>';	echo '<br/>';	echo '<br/>';	
#var_dump($req_val);
							// line item
							if(!isset($this->parsedAST[$fy]->line_items[$req_val->line2desc])) $this->parsedAST[$fy]->line_items[$req_val->line2desc] = new \StdClass();
							if(!isset($this->parsedAST[$fy]->line_items[$req_val->line2desc]->activities)) $this->parsedAST[$fy]->line_items[$req_val->line2desc]->activities = [];
							if(!isset($this->parsedAST[$fy]->line_items[$req_val->line2desc]->activities[$act_val->activitydesc])) $this->parsedAST[$fy]->line_items[$req_val->line2desc]->activities[$act_val->activitydesc] = [];
							$this->parsedAST[$fy]->line_items[$req_val->line2desc]->activities[$act_val->activitydesc][] = $req_val;
